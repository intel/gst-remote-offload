  ...
  if(DEFINED ENV{XLINK_HOME})
    FIND_LIBRARY(xlinkARM_LIBRARY NAME XLinkARM PATHS
         $ENV{XLINK_HOME}/lib DOX "XLink ARM (server) library")
    FIND_LIBRARY(xlinkPC_LIBRARY NAME XLinkPC PATHS
         $ENV{XLINK_HOME}/lib DOX "XLink PC (host) library")
    SET(USE_XLINK 1 )
